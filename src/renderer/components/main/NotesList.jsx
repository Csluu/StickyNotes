...
export default function NotesList({ notes, searchQuery, onOpenNote, onCreateNote }) {
  ...
  return (
    <section id="noteCardsContainer" className="swim-lane no-drag overflow-scroll rounded-xl text-base text-gray-200">
      {notes.length === 0 ? (
        ...
        <>
          ...
          {archivedCount > 0 && (
            <div className="mt-4 border-t border-gray-700 pt-3">
              ...
              >
                <span>Archived</span>
                <span className="rounded bg-gray-700 px-1.5 text-xs">{archivedCount}</span>
                <svg
